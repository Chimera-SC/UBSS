    ...
    class LoginMessage : Message
    {
        ...
        public override void Decode()
        {
            using (var br = new BinaryReader(new MemoryStream(GetData())))
            {
                ...
                m_vClientSeed = 0;//br.ReadUInt32WithEndian();
        ...
        public override void Process(Level level)
        {
            ...
            if(versionData.Length >= 2)
            {
                if(m_vClientMajorVersion != Convert.ToInt32(versionData[0]) || m_vClientBuild != Convert.ToInt32(versionData[1]))
                {
                    var p = new LoginFailedMessage(this.Client);
                    p.SetErrorCode(8);
                    p.SetUpdateURL("market://details?id=com.supercell.brawlstars");
                    PacketManager.ProcessOutgoingPacket(p);
                    return;
                }
            }
            ...
            {
                Debugger.WriteLine("Connection failed. UBSS config key clientVersion is not properly set.");
            }
            ...
            loginOk.SetAccountId(1/*avatar.GetId()*/);
            ...
            /*if (alliance != null)
            {
                ...
                //PacketManager.ProcessOutgoingPacket(new AllianceWarMapDataMessage(this.Client));
            }*/
        }
    }
}
